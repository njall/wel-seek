...
ASSET_ORDER                = ['Person', 'Project', 'Institution', 'Investigation', 'Study', 'Experiment', 'Sample','Specimen','DataFile', 'Model', 'Protocol', 'Publication', 'Presentation','SavedSearch', 'Organism', 'Event']
