class UpdatedAuthLookupTablesToUseUserId < ActiveRecord::Migration
  ...
  def self.up
    rename_column :experiment_auth_lookup,:person_id, :user_id
    ...
    rename_column :protocol_auth_lookup,:person_id, :user_id
    ...
    remove_index :experiment_auth_lookup, [:person_id,:can_view]
    add_index :experiment_auth_lookup, [:user_id, :can_view]
    ...
    remove_index :protocol_auth_lookup, [:person_id,:can_view]
    add_index :protocol_auth_lookup, [:user_id, :can_view]
  ...
  def self.down
    rename_column :experiment_auth_lookup,:user_id,:person_id
    ...
    rename_column :protocol_auth_lookup,:user_id,:person_id
    rename_column :specimen_auth_lookup,:user_id,:person_id
    rename_column :study_auth_lookup,:user_id,:person_id

    remove_index :experiment_auth_lookup, [:user_id,:can_view]
    add_index :experiment_auth_lookup, [:person_id, :can_view]
    ...
    remove_index :protocol_auth_lookup, [:user_id,:can_view]
