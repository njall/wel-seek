...
ActiveRecord::Schema.define(:version => 20120827144459) do
  ...
  create_table "experiment_assets", :force => true do |t|
  ...
  add_index "experiment_assets", ["asset_id", "asset_type"], :name => "index_assay_assets_on_asset_id_and_asset_type"
  add_index "experiment_assets", ["experiment_id"], :name => "index_assay_assets_on_assay_id"

  create_table "experiment_auth_lookup", :id => false, :force => true do |t|
    t.integer "user_id"
    t.integer "asset_id"
    t.boolean "can_view",     :default => false
    t.boolean "can_manage",   :default => false
  ...
  add_index "experiment_auth_lookup", ["user_id", "can_view"], :name => "index_assay_auth_lookup_on_user_id_and_can_view"

  create_table "experiment_classes", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "experiment_organisms", :force => true do |t|
    t.integer  "experiment_id"
    t.integer  "organism_id"
  ...
  add_index "experiment_organisms", ["experiment_id"], :name => "index_assay_organisms_on_assay_id"
  add_index "experiment_organisms", ["organism_id"], :name => "index_assay_organisms_on_organism_id"
  ...
  create_table "experiment_types_edges", :id => false, :force => true do |t|
    t.integer "parent_id"
    t.integer "child_id"
  end
  ...
  add_index "experimental_conditions", ["protocol_id"], :name => "index_experimental_conditions_on_protocol_id"
  ...
  create_table "projects_protocol_versions", :id => false, :force => true do |t|
    t.integer "project_id"
    t.integer "version_id"
  end

  create_table "projects_protocols", :id => false, :force => true do |t|
    t.integer "project_id"
    t.integer "protocol_id"
  end
  ...
  create_table "protocol_auth_lookup", :id => false, :force => true do |t|
    t.integer "user_id"
    t.integer "asset_id"
    t.boolean "can_view",     :default => false
    t.boolean "can_manage",   :default => false
  ...
  add_index "protocol_auth_lookup", ["user_id", "can_view"], :name => "index_protocol_auth_lookup_on_user_id_and_can_view"

  create_table "protocol_specimens", :force => true do |t|
    t.integer "specimen_id"
    t.integer "protocol_id"
    t.integer "protocol_version"
  end
  ...
  add_index "protocol_versions", ["contributor_id", "contributor_type"], :name => "index_protocol_versions_on_contributor_id_and_contributor_type"
  add_index "protocol_versions", ["protocol_id"], :name => "index_protocol_versions_on_protocol_id"
  ...
  add_index "protocols", ["contributor_id", "contributor_type"], :name => "index_protocols_on_contributor_id_and_contributor_type"
  ...
  create_table "sample_protocols", :force => true do |t|
    t.integer "sample_id"
    t.integer "protocol_id"
    t.integer "protocol_version"
  end
