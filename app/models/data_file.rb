...
class DataFile < ActiveRecord::Base
  ...
  searchable(:auto_index=>false) do
    text :description, :title, :original_filename, :searchable_tags, :spreadsheet_annotation_search_fields,:fs_search_fields, :spreadsheet_contents_for_search,
         :experiment_type_titles,:technology_type_titles
  ...
  explicit_versioning(:version_column => "version") do
    ...
    def relationship_type(experiment)
      parent.relationship_type(experiment)
    end
  end
  ...
  def relationship_type(experiment)
    #FIXME: don't like this hardwiring to experiment within data file, needs abstracting
    experiment_assets.find_by_experiment_id(experiment.id).relationship_type
  end
