class StrainsController < ApplicationController
  before_filter :get_strains,:only=>[:show_existing_strains, :existing_strains_for_experiment_organism]
  ...
  def existing_strains_for_experiment_organism
    render :update do |page|
      if @strains && @organism
        page.replace_html 'existing_strains_for_experiment_organism', :partial=>"strains/existing_strains_for_experiment_organism",:object=>@strains,:locals=>{:organism=>@organism}
      else
        page.insert_html :bottom, 'existing_strains_for_experiment_organism',:text=>""
      end
    end
  end
