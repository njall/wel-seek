...
class TechnologyTypeTest < ActiveSupport::TestCase
  fixtures :technology_types,:experiments
  ...
  test "to tree" do
    ...
    assert roots.include?(technology_types(:technology_type_with_child_and_experiment))
    assert roots.include?(technology_types(:technology_type_with_child))
    assert roots.include?(technology_types(:technology_type_with_only_child_experiments))
  ...
  test "experiments association" do
    ...
    a2=technology_types(:child_technology_type_with_experiment)
    assert a2.experiments.include?(experiments(:technology_type_test_experiment2))
  end
