...
#this is required to initialise the @<model> (e.g. @protocol), before re-rendering the :new page
    ...
    def download_jerm_asset asset
      ...
      resource_type = asset.class.name.split("::")[0] #need to handle versions, e.g. Protocol::Version
      begin
