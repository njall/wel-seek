module Seek
  module Util
    ...
    #List of activerecord model classes that are directly creatable by a standard user (e.g. uploading a new DataFile, creating a new Experiment, but NOT creating a new Project)
