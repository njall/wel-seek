...
function getProjectIds(resource_name){
    ...
    //in case of experiment, return the id of study, then from the server side, the project_ids are retrieved
    else if (resource_name == 'experiment'){
       project_ids = $F('experiment_study_id')
    }
    else{
